          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -8 }}
              >
                <Card className="overflow-hidden border-border hover:shadow-premium transition-shadow duration-300 bg-card group h-full">
                  {/* Icon Header */}
                  <div className="p-6 pb-0">
                    <motion.div 
                      className="w-14 h-14 bg-primary rounded-xl flex items-center justify-center shadow-premium mb-4"
