              ...
              <TabsContent key={key} value={key}>
                ...
                >
                  <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold mb-2 text-foreground">{service.title}</h2>
                  ...
                  {'isRateCard' in service && service.isRateCard ? (
                    ...
                    >
                      ...
                      <div className="text-center mb-8">
                        <h3 className="text-2xl font-bold text-foreground mb-2">Individual Service Prices</h3>
                        <p className="text-foreground">Quality designs at affordable rates</p>
                      </div>
                        ...
                        {graphicDesignServices.map((item, index) => (
                          ...
                          >
                            <Card className={`p-5 h-full hover:shadow-premium transition-all duration-300 hover:-translate-y-1 group relative ${item.popular ? 'border-primary/50 bg-primary/5' : ''}`}>
                              ...
                              <p className="text-sm text-foreground leading-relaxed pl-12">{item.description}</p>
                            </Card>
                          </motion.div>
                        ))}
                      </div>
                      ...
                      <div className="mt-16">
                        <div className="text-center mb-8">
                          <h3 className="text-2xl font-bold text-foreground mb-2">Bundle & Save</h3>
                          <p className="text-foreground">Get more value with our discounted package deals</p>
                        </div>
                          ...
                          {designBundles.map((bundle, index) => (
                            ...
                            >
                              <Card className={`p-6 h-full hover:shadow-premium transition-all duration-300 hover:-translate-y-1 relative overflow-hidden ${bundle.popular ? 'border-primary ring-2 ring-primary/20' : ''}`}>
                                ...
                                <p className="text-sm text-foreground mb-4">{bundle.description}</p>
                                <div className="mb-4">
                      ...
                      <div className="mt-16">
                        <div className="text-center mb-8">
                          <h3 className="text-2xl font-bold text-foreground mb-2">Build Your Own Bundle</h3>
                          <p className="text-foreground">Select multiple services and see your savings in real-time</p>
                      ...
                      <div className="mt-10 text-center">
                        <p className="text-foreground mb-4">Need a custom package? Contact us for a personalized quote!</p>
                    ...
                    >
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="mb-6">
                                ...
                                <p className={`text-sm ${plan.popular ? "text-primary-foreground/80" : "text-foreground"}`}>
                                  {plan.description}
                                </p>
                              </div>
                              ...
                              <div className="mb-6">
                                ...
                                <span className={`text-sm ${plan.popular ? "text-primary-foreground/80" : "text-foreground"}`}>
                                  {plan.period}
                                </span>
                              </div>
                      ...
                      {key === 'videoEditing' && (
                        <div className="mt-16">
                          <div className="text-center mb-8">
                            <h3 className="text-2xl font-bold text-foreground mb-2">Bundle & Save</h3>
                            <p className="text-foreground">Get more value with our discounted video editing packages</p>
                          </div>
                          <div className="grid md:grid-cols-3 gap-6">
                      ...
                      {key === 'socialMedia' && (
                        <div className="mt-16">
                          <div className="text-center mb-8">
                            <h3 className="text-2xl font-bold text-foreground mb-2">Bundle & Save</h3>
                            <p className="text-foreground">Get more value with our discounted social media packages</p>
                          </div>
                          <div className="grid md:grid-cols-3 gap-6">
                      ...
                      {categoryServices[key] && (
                        <div className="mt-16">
                          <div className="text-center mb-8">
                            <h3 className="text-2xl font-bold text-foreground mb-2">Build Your Own Bundle</h3>
                            <p className="text-foreground">Select individual services and see your savings in real-time</p>
                          </div>
                          <div className="max-w-2xl mx-auto">
