          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Our graphic design services bring your ideas to life with creative solutions that resonate with your target audience. From brand identity to marketing materials, we create designs that stand out.
              </p>
