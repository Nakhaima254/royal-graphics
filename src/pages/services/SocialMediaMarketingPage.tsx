          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                We help you build meaningful connections with your audience through strategic social media marketing. From content creation to community management, we handle it all.
              </p>
