...
var BUSINESS_INFO = {
  ...
  whatsappNote: "WhatsApp is the primary contact method. All pricing buttons and forms on the site redirect to WhatsApp with a pre-filled message.",
  ...
  paymentTerms: "Strict 60% upfront payment (60/40 split) for all designs and services. The 60% secures the project slot; the remaining 40% is due on final approval before file handover.",
  bulkDiscounts: [
    { minServices: 6, discount: "15%" },
    { minServices: 4, discount: "10%" },
    { minServices: 2, discount: "5%" }
  ],
  bulkDiscountNote: "Tiered discount applies when bundling multiple individual services in one order: 5% off 2+ services, 10% off 4+, 15% off 6+."
};
var SERVICES = [
  {
    name: "Graphic Design",
    ...
    summary: "Logos, business cards, flyers, banners, brochures, product labels and full brand identity assets, delivered print-ready."
  },
  {
    name: "Social Media Marketing",
    slug: "social-media-marketing",
    path: "/services/social-media-marketing",
    summary: "Profile setup, content calendars, post design and growth strategies for Instagram, Facebook and TikTok."
  },
  {
    name: "Copywriting",
    slug: "copywriting",
    path: "/services/copywriting",
    summary: "SEO blog posts, website copy, product descriptions, ad copy and email sequences that convert."
  },
  {
    name: "Video Editing",
    slug: "video-editing",
    path: "/services/video-editing",
    summary: "Basic to cinematic video editing, reels, intros/outros, color grading, subtitles and thumbnails."
  },
  {
    name: "Email Marketing",
    slug: "email-marketing",
    path: "/services/email-marketing",
    summary: "Responsive templates, campaign setup, automation sequences, segmentation and analytics."
  },
  {
    name: "SMS Marketing",
    slug: "sms-marketing",
    path: "/services/sms-marketing",
    summary: "Bulk SMS campaigns, sender ID registration, scheduling and delivery analytics for the Kenyan market."
  },
  {
    name: "Web Development",
    slug: "web-development",
    path: "/services/web-development",
    summary: "Business websites, landing pages and e-commerce builds with modern, mobile-first design."
  },
  {
    name: "Training",
    slug: "training",
    path: "/services/training",
    summary: "Practical design and digital marketing training, including a full graphic design course."
  }
];
var INDIVIDUAL_PRICING = {
  "Graphic Design": [
...
var list_services_default = defineTool({
  name: "list_services",
  title: "List services",
  description: "List the digital design and marketing services offered by Royal Digital Elevation (Nairobi, Kenya), with summaries and site paths.",
  inputSchema: {},
...
var get_pricing_default = defineTool2({
  name: "get_pricing",
  title: "Get pricing",
  description: "Get Royal Digital Elevation pricing in KES: individual service rates, bundle packages, monthly plans, bulk-bundle discounts and payment terms. Optionally filter to one service category.",
  inputSchema: {
  ...
  handler: ({ category }) => {
    ...
    const pricing = {
      ...
      howToOrder: "Orders are placed via WhatsApp (+254 746 388 308) with a pre-filled message from the site."
    };
    return {
...
var list_blog_posts_default = defineTool3({
  ...
  description: "List blog posts from Royal Digital Elevation (SEO, Design, Social Media and Marketing topics) with title, excerpt, category, date and featured image. Optionally filter by category.",
  inputSchema: {
    category: z2.string().optional().describe('Optional category filter, e.g. "SEO", "Design", "Social Media", "Marketing". Omit for all posts.')
  },
  annotations: { readOnlyHint: true, idempotentHint: true, openWorldHint: false },
  handler: ({ category }) => {
    const posts = blogPostsData.filter(
...
var get_blog_post_default = defineTool4({
  name: "get_blog_post",
  title: "Get blog post",
  description: "Get the full content of a single Royal Digital Elevation blog post by its slug (from list_blog_posts). Returns title, metadata, featured image and full HTML content.",
  inputSchema: {
    slug: z3.string().trim().min(1).describe('The post slug, e.g. "10-essential-seo-tips-for-2025".')
  },
  annotations: { readOnlyHint: true, idempotentHint: true, openWorldHint: false },
  handler: ({ slug }) => {
...
var get_business_info_default = defineTool5({
  ...
  description: "Get Royal Digital Elevation's public business details: contact email, phone, WhatsApp, location, social media links, and payment terms.",
  inputSchema: {},
  annotations: { readOnlyHint: true, idempotentHint: true, openWorldHint: false },
  handler: () => ({
...
var mcp_default = defineMcp({
  ...
  version: "0.1.0",
  instructions: "Tools for Royal Digital Elevation, a digital design and marketing studio in Nairobi, Kenya. Use list_services to see offerings, get_pricing for KES prices, bundles, bulk discounts and the 60/40 payment terms, list_blog_posts and get_blog_post for blog content, and get_business_info for contact details. All tools serve public marketing content; no authentication is required.",
  tools: [
    list_services_default,
    get_pricing_default,
    list_blog_posts_default,
    get_blog_post_default,
    get_business_info_default
  ]
});
